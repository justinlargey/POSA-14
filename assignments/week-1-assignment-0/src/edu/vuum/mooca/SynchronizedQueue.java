   ...
   public enum SynchronizedQueueResult {
    ...
    public static SynchronizedQueueResult testQueue(QueueAdapter<Integer> queue) {
        try {
            ...
            // When putting consumer first, nothing is written to the console until the producer is started.
            // This makes sense because the consumer is waiting for the producer to put something on the queue.
            producer.start();
            consumer.start();
